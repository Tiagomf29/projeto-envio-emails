...
public class EnvioDeEmailSpdata {

	  static String emailDestinatario = "tiago@spdata.com.br";
	  static String nomeDestinatario = "Teste";
	  static String emailRemetente = "tiago@spdata.com.br";
	  ...
	  static String username = "tiago@spdata.com.br"; // do painel de controle do SMTP
	  ...
	  public static void main(String[] args)
	  {
	    ...
	    try
	    {
	      ...
	      System.out.println("SPDATA - Enviado com sucesso!");
