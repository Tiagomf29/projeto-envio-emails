...
public class EnvioDeEmailGmail {
	  ...
	  static String servidor = "smtp.gmail.com";  // do painel de controle do SMTP
	  static String username = "tiagomf92@gmail.com"; // do painel de controle do SMTP
	  static String senha = Autenticacao.senhaGmail; // do painel de controle do SMTP
	  ...
	  public static void main(String[] args)
	  {
	    ...
	    try
	    {
	      ...
	      System.out.println("Gmail - Enviado com sucesso!");
