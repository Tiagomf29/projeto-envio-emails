...
public class EnvioDeEmailOutlook {

	  static String emailDestinatario = "tiagomf29@outlook.pt";
	  static String nomeDestinatario = "Teste";
	  static String emailRemetente = "tiagomf29@outlook.pt";
	  ...
	  static String username = "tiagomf29@outlook.pt"; // do painel de controle do SMTP
	  ...
	  public static void main(String[] args)
	  {
	    ...
	    try
	    {
	      ...
	      System.out.println("Outlook - Enviado com sucesso!");
