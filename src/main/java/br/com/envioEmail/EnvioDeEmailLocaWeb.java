...
public class EnvioDeEmailLocaWeb {
	  ...
	  static String servidor = "email-ssl.com.br";  // do painel de controle do SMTP
	  static String username = "xxxx@cvida.com.br"; // do painel de controle do SMTP
	  ...
	  public static void main(String[] args)
	  {
	    ...
	    try
	    {
	      ...
	      System.out.println("LocaWeb - Enviado com sucesso!");
